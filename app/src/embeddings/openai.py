...
class OpenAIEmbedding(EmbeddingModel):
    ...
    def __init__(self, model_name: str = "text-embedding-3-small", api_key: str = None, base_url: str = None):
        ...
        self._tokenizer = tiktoken.get_encoding("cl100k_base")  # Default encoding for text-embedding models
    ...
    def max_seq_length(self) -> int:
        ...
        Note: This is a simplified approach. Different OpenAI embedding models 
        have different token limits. For production use, you might want to 
        implement a more dynamic approach to determine the max length based 
        on the specific model being used.
        """
        # Default values based on OpenAI documentation
        model_limits = {
